...
rule dbslmm_prep:
    ...
    input: 
        ...
        ld_ref=rules.download_dbslmm_ld_ref.output.ld_ref,
    ...
    shell:
        ...
        "--ref_plink_chr {config[Geno_1KG_dir]}/1KGPhase3.w_hm3.GW "
...
# TODO fix error Failed to open resources/Geno_1KG/1KGPhase3.w_hm3.GW20.bed.
